...
[![Licença](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/Duzim/rust-industrial-theme/blob/HEAD/LICENSE)
...
| :------------------------------------------------: | :--------------------------------------------------: |
| ![Demonstração do Dark Mode](https://github.com/Duzim/rust-industrial-theme/raw/HEAD/imgs/dark_demo.png) | ![Demonstração do Light Mode](https://github.com/Duzim/rust-industrial-theme/raw/HEAD/imgs/light_demo.png) |
